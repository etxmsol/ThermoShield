...
#define SAMPLE_WINDOW	60		// number of samples to keep in the ring buffer for averaging
...
private:	// note: no doxygen documentation is generated by default for private members
	...
	float mSampleWindow[SAMPLE_WINDOW];	//!< A sliding window used as a SW filter. The last 60 samples
...
public:
	 ...
	 */
	static const unsigned long samplePeriod = 1000;
	...
	static const float R0 = 100000;		//!< The thermistor used is 100K at 25C
};
